...
function scaleit(){
    ...
    setTimeout(function () {
   window.location.href = "https://lrylander.github.io/linnearylander/site/inside.html"; //REPLACE WITH REAL LINK
}, 2000);
...
function sky(){
    window.location = 'https://lrylander.github.io/linnearylander/site/sky2/index.html'
}

function mccormick(){
    window.location = 'https://lrylander.github.io/linnearylander/site/hobbies/index.html'
}

//if (screen.width <= 699) {
//document.location = "https://lrylander.github.io/linnearylander/site/mobile";
//}
